...
PsActivity.prototype.init = function()
{
	...
	jQuery(document).on("ps_comment_addon_added ps_comment_addon_removed", function( e, addon ) {
		var $ct = jQuery( addon ).closest('.ps-js-addons'),
...
PsActivity.prototype.show_comments = function(act_id)
{
	...
	$PeepSo.postJson("activity.show_previous_comments", req, function(json) {
...
PsActivity.prototype.option_edit = function(post_id, act_id)
{
	...
	if ( this.is_ajax_loading[ flag ] )
		return;

	this.is_ajax_loading[ flag ] = true;
...
PsActivity.prototype.load_page = function(page)
{
	...
	this.page_loading = $PeepSo.postJson("activity.show_posts_per_page", req, function(json) {
		var $new_posts;
