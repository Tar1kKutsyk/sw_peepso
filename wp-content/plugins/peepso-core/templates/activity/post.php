<div class="ps-stream ps-js-activity ps-js-activity--<?php echo $act_id; ?>" data-id="<?php echo $act_id; ?>">
		...
		<div class="ps-avatar-stream">
			<a href="<?php peepso('user-link', $post_author); ?>">
				<img data-author="<?php echo $post_author; ?>" src="<?php peepso('avatar', $post_author); ?>" alt="" />
                    ...
                    <?php $href = peepso('activity', 'link');
                    $a = str_replace('/peepso/','/peepso.com/', $href); ?>                    
                    <div class="fb-share-button" data-href="<?=$a?>" data-layout="button_count" data-size="small" data-mobile-iframe="true">
	...
	<div class="ps-comment cstream-respond wall-cocs" id="wall-cmt-<?php echo $act_id; ?>">
		...
		<div id="act-new-comment-<?php echo $act_id; ?>" class="ps-comment-reply cstream-form stream-form wallform ps-js-newcomment-<?php echo $act_id; ?>" data-type="stream-newcomment" data-formblock="true">
			...
			<div class="ps-textarea-wrapper cstream-form-input">
				...
				peepso('activity', 'show-commentsbox-addons');
				?>
			</div>
