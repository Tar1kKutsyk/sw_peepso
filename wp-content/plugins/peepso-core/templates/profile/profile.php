            ...
            <div id="cProfileWrapper" class="clearfix">
                ...
                <div class="ps-body">
                    ...
                    if (peepso('profile', 'get.has-sidebar') || count($widgets_profile_sidebar_top) > 0 || count($widgets_profile_sidebar_bottom) > 0) { ?>
                        <?php 
                        ob_start();
                        peepso('load-template', 'sidebar/sidebar', array('profile_sidebar_top'=>$widgets_profile_sidebar_top, 'profile_sidebar_bottom'=>$widgets_profile_sidebar_bottom, ));
                    ...
                    <div class="ps-main <?php if (peepso('profile', 'get.has-sidebar') || strlen($sidebar)) echo ''; else echo 'ps-main-full'; ?>">
                        <!-- js_profile_feed_top -->
